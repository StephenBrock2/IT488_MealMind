...
class TestSQLUserRepository(unittest.TestCase):
    ...
    def test_update_meal_plan(self):
        ...
        recipe1 = Recipe(id = None, title = 'Krabby Patty', instructions = 'Cook patty. Assemble sandwich', user_id = None, cook_time = 15)
        recipe2 = Recipe(id = None, title = 'Kelp Shake', instructions = 'Blend ingredients', user_id = None, cook_time = 5)
        created_recipe1 = recipe_repo.create_recipe(recipe1)
        created_recipe2 = recipe_repo.create_recipe(recipe2)
...
class TestSQLRecipeRepository(unittest.TestCase):
    ...
    def test_create_recipe_2(self):
        ...
        recipe = Recipe(id = None, title = 'Krabby Patty Deluxe', instructions = 'Cook patty. Add toppings. Assemble', user_id = None, cook_time = 20)
        ...
        created_recipe = recipe_repo.create_recipe_2(recipe, ingredients, ingredient_repo)
    ...
    def test_get_random_recipe(self):
        ...
        recipe = Recipe(id = None, title = 'Random Recipe', instructions = 'Random', user_id = None, cook_time = 10)
        created_recipe = recipe_repo.create_recipe(recipe)
